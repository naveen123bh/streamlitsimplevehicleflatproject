...
import pandas as pd
import difflib
from technician import TECHNICIAN_NAMES  # Technician names separated in another file
...
# ==============================
st.markdown("<p style='color:green; font-style:italic;'>This code is highly optimized in terms of memory (naveen123github repo)</p>", unsafe_allow_html=True)
