...
for col in ["Technician","Floor","SetName","Sister","DateTime"]:
    if col not in log_df.columns:
        log_df[col] = ""

log_df = log_df[["Technician","Floor","SetName","Sister","DateTime"]]
...
if st.session_state.current_floor:
    ...
    if st.button("Issue"):
        ...
        st.success(f"{set_name} issued successfully to {sister_name} at {current_time}")
