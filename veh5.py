...
# ===== Full hardcoded vehicle → flat mapping =====
vehicle_flat_pairs = {
    ...
    # Add your full pasted NumberMHO1 list
...
# ===== Invert dictionary to allow flat → list of vehicles -----
flat_to_vehicles = {}
...
if st.button("रिज़ल्ट देखें", key="lookup_button"):
    ...
    # ----- Flat lookup: show all vehicles related to this flat -----
        ...
        st.markdown("<h2 style='color:red; font-size:50px;'>..यह गाड़ी रिषभ टावर की वाहन सूची में नहीं है। शायद यह नई वाहन हो सकती है या फिर इसे सूची में नहीं डाला गया है।  ..<br>..गाड़ी के मालिक से फ्लैट नंबर पूछें या मैनेजर से बात करें।</h2>", unsafe_allow_html=True)
